...
<html class="no-js" prefix="og: http://ogp.me/ns#"  lang="en-IN">
              ...
              <div class="container"> 
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <form id="contactForm" name="sentMessage" action="index.php" method="post" novalidate>
                      <div class="row">
                        <div class="col-md-6">
 ...
 <?php
  ...
  $sql="INSERT INTO `contact form` (`name`, `email`, `phone`, `message`) VALUES ('$name', '$email', '$phone', '$message')";
              ...
              <!-- FOOTER 
                ...
                <footer>
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-5">
                        <span class="copyright">Copyright &copy; 2024 Design By Sonam Vishwakarma</span>
                      </div>
                      <div class="col-md-3">
                        <ul class="list-inline social-buttons">
                          <li class="list-inline-item">
                            <a href="https://t.ly/lOUyC">
                              <i class="fa fa-whatsapp"></i>
                            </a>
                          </li>
                          <li class="list-inline-item">
                            <a href="https://www.facebook.com/profile.php?id=100060287047746&mibextid=ZbWKwL">
                              <i class="fa fa-facebook"></i>
                            </a>
                          </li>
                          <li class="list-inline-item">
                            <a href="https://www.linkedin.com/in/sonam-vishwakarma">
